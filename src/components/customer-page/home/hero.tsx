      ...
      <div className="container mx-auto relative px-4 py-16 md:py-24 lg:py-32">
        <div className="grid grid-cols-1 items-center gap-8 md:grid-cols-2">
          ...
          <div className="max-w-xl">
            <div className="inline-flex items-center px-4 py-1.5 mb-6 gap-2 rounded-full border border-primary/60 bg-primary/10 font-medium text-primary ">
              <Sparkle size={14} />
              <span>ยินดีต้อนรับสู่เว็บไซต์ของเรา</span>
            </div>

            <h1 className="text-4xl md:text-6xl font-bold">
              ช็อปสินค้าไอที
              <span className="block mt-2 bg-gradient-to-r from-primary/70 bg-clip-text text-transparent">
                ราคาคุ้มค่า
              </span>
            </h1>

            <p className="mt-6 text-lg text-muted-foreground">
              ร้านค้าออนไลน์อันดับ 1 สำหรับสินค้าไอที
              พร้อมบริการจัดส่งและราคาที่คุ้มค่า
            </p>
            ...
            <div className="relative z-10 flex items-center">
              <div className="relative size-[400px]">
                <Image
                  ...
                  fill
                  className="object-cover rounded-lg scale-110 hover:scale-105 hover:shadow-md hover:shadow-primary transition-all duration-500"
                />
