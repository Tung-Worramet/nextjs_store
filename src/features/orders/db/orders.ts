...
import { getOrderGlobalTag, getOrderIdTag, revalidateOrderCache } from "@/features/orders/db/cache";
import {
...
export const uploadPaymentSlip = async (orderId: string, file: File) => {
    ...
    try {
        ...
        return {
            message: "เกิดข้อผิดพลาดในการอัพโหลดสลิปการชำระเงิน กรุณาลองใหม่ในภายหลัง",
        }
    }
}
